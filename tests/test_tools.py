...
from gti_mcp_server.server import server
from gti_mcp_server import tools
from gti_mcp_server.tools import collections
...
async def test_search_digital_threat_monitoring_errors(
    ...
    with patch('gti_mcp_server.tools.files.vt_client') as mock_vt_client:
...
async def test_get_collection_rules_all_types():
    ...
    with patch("gti_mcp_server.tools.collections.vt_client", return_value=mock_vt_client):
